          ...
          <footer className="text-gray-600 body-font">
              ...
              <div className="bg-gray-100">
                  <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                      <Logo></Logo>
                      <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© {new Date().getFullYear()} ReCommerce —
                          <a href="https://twitter.com/jyotiyadav" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@madebyJyoti</a>
                      </p>
